...
CREATE TABLE IF NOT EXISTS `mydb`.`ServiceType` (
  `idServiceType` INT(11) NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Service` (
  ...
  PRIMARY KEY (`Employee_EmployeeType_idEmployeeType`, `ServiceType_idServiceType`, `ServiceStatus_idServiceStatus`, `Registry_idRegistry`),
