...
CREATE TABLE IF NOT EXISTS `mydb`.`Service` (
  ...
  `ServiceType_nameServiceType` VARCHAR(45) NOT NULL,
  `Registry_idRegistry` INT(11) NOT NULL,
  PRIMARY KEY (`Registry_idRegistry`),
  ...
  INDEX `fk_Service_ServiceType1_idx` (`ServiceType_nameServiceType` ASC),
  ...
  CONSTRAINT `fk_Service_ServiceType1`
    FOREIGN KEY (`ServiceType_nameServiceType`)
    REFERENCES `mydb`.`ServiceType` (`nameServiceType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
